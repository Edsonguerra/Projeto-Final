...
<head>
    ...
    <link rel="stylesheet" href="../public/assets/css/Gerenciamento_análise.css">
...
<body>
    ...
    <div class="container">
        <table class="table-analise">
            ...
            <td>
            <a href="Atualizar_consulta.php?updateid=' . $id_da_analise . '">
            <button class="btn-atualizar">Atualizar</button>
            </a>
            
            <a href="../modules/Eliminar_consulta.php?deleteid=' . $id_da_analise . '">
