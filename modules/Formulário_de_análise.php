...
if (isset($_POST['submit'])) {
    ...
    if (isset($_SESSION['id_user'])) {
        ...
        if ($result) {
            $_SESSION['mensagem2'] = "com sucesso!";
        } else {
            $_SESSION['mensagem2'] = "Erro ao inserir paciente: " . mysqli_error($mysqli);
        }
    } else {
        $_SESSION['mensagem2'] = "Erro: usuário não está logado.";
    }
...
<head>
    ...
    <link rel="stylesheet" href="../public/assets/css/Formulario_de_análise.css">
        ...
        <div class="detalhes">
            ...
            <div class="submite-formulario">
                ...
                <form action="../modules/Formulário_de_análise.php" method="POST">
                    <h5 class="titulo">Formulário de Analise</h5>
                    <div class="input-box">
